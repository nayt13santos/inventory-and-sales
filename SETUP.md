...
To confirm which version a phone is on: **More → About**. Current release: **app 2.9.5**, **script 2.9.5**.
...
Current versions: **script 2.9.5**, **app 2.9.5**. You can check what each phone is actually running under **More → About**.

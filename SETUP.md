...
To confirm which version a phone is on: **More → About**. Current release: **app 2.25.0**, **script 2.25.0**.
...
Current versions: **script 2.25.0**, **app 2.25.0**. You can check what each phone is actually running under **More → About**.

...
To confirm which version a phone is on: **More → About**. Current release: **app 2.9.8**, **script 2.9.8**.
...
Current versions: **script 2.9.8**, **app 2.9.8**. You can check what each phone is actually running under **More → About**.

...
To confirm which version a phone is on: **More → About**. Current release: **app 2.12.1**, **script 2.12.1**.
...
Current versions: **script 2.12.1**, **app 2.12.1**. You can check what each phone is actually running under **More → About**.
